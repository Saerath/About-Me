...
- проект с телеграм-ботом, google sheets, google scripts, в рамках которого использовал ресурс *codeacademy*, **github:** [link](https://github.com/Saerath/NROOSJ-events-table)
  - *о JS* **codeacademy**;
  - *о HTML* **codeacademy**;
- умение пользоваться системой контроля версиями **git** в консольном виде.
- SQL - простые запросы SELECT.
- опыт работы в отделе R&D на производстве полупроводниковых лазеров, связанный с программированием:
